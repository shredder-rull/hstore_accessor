...
describe HstoreAccessor do
  ...
  describe "scopes" do
    ...
    context "for integer fields support" do
      ...
      it "in_array" do
        expect(Product.price_in([10, 30]).to_a).to eq [product_a, product_c]
      end

      it "between" do
        expect(Product.price_between(5,25).to_a).to eq [product_a, product_b]
      end
    end
    ...
    context "for float fields support" do
      ...
      it "in_array" do
        expect(Product.weight_in([10.1, 30.3]).to_a).to eq [product_a, product_c]
      end

      it "between" do
        expect(Product.weight_between(5,30).to_a).to eq [product_a, product_b]
      end
    end
    ...
    context "for decimal fields support" do
      ...
      it "in_array" do
        expect(Product.miles_in([BigDecimal.new("10.113379001"), BigDecimal.new("30.313379001")]).to_a).to eq [product_a, product_c]
      end

      it "between" do
        expect(Product.miles_between(BigDecimal.new("5.1111111"), BigDecimal.new("30.111111111")).to_a).to eq [product_a, product_b]
      end
    end
